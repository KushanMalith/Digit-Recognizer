...
y_train = train_data['pixel0']  # Use the first column as labels
X_train = train_data.drop(columns=['pixel0'], axis=1) / 255.0  # Exclude the first column containing labels
